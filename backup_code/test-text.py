...
Full_TextEditor2 = [
    ...
    [sg.Multiline('', size=(60, 20), key='MULTILINE2',expand_y=True,expand_x=True,enable_events=True,font=font,background_color="#18012e")],
]
...
pythonCodeRunner = [
    ...
    [sg.Button("Run", expand_x=True,font=font)],
    #[sg.Multiline(expand_x=True,expand_y=True, key="-TEXTBOX-",size=(900,900),background_color="#18012e")],
    
    [sg.Multiline('', size=(60, 20), key='MULTILINE3',expand_y=True,expand_x=True,enable_events=True,font=font,background_color="#18012e")],
]
